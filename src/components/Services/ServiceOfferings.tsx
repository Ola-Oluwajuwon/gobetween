...
import { Code, Palette, Zap, Smartphone, Database, Cloud, ArrowRight, Mail } from 'lucide-react'
...
const services = [
  ...
  },
  {
    ...
    icon: Zap,
    description: 'Custom automation tools and workflows to streamline business processes.',
    features: [
  ...
  },
  {
    ...
    title: 'DevOps & Cloud',
    icon: Cloud,
    description: 'Infrastructure setup, deployment automation, and cloud migration services.',
    features: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive digital services designed to meet your specific needs. 
              Each service is tailored to deliver maximum value and results.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
              ...
              tailored to your specific requirements. Let's discuss your project and find 

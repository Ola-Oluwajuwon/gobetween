...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'Discover how artificial intelligence is revolutionizing user interface design and creating more intuitive, personalized user experiences.',
  ...
  },
  {
    ...
    excerpt: 'Learn the most effective techniques for optimizing React applications, from code splitting to memoization and beyond.',
    category: 'Web Development',
  ...
  },
  {
    ...
    excerpt: 'Set up comprehensive CI/CD pipelines and automate your development workflow using GitHub Actions and modern DevOps practices.',
    category: 'DevOps',
  ...
  },
  {
    ...
    excerpt: 'Learn how to build web applications that are accessible to all users, following WCAG guidelines and best practices.',
    category: 'Web Development',
  ...
  },
  {
    ...
    excerpt: 'Explore the benefits of TypeScript and why it\'s becoming a must-have skill for modern web developers.',
...
const categories = ['All', 'Web Development', 'UI/UX Design', 'DevOps', 'Programming']
          ...
          >
            <div className="flex flex-wrap justify-center gap-3">
              {categories.map((category) => (
                <button
                  key={category}
                  className="px-4 py-2 rounded-full bg-background border hover:bg-primary hover:text-primary-foreground transition-colors"
                >
                  {category}
                </button>
              ))}
